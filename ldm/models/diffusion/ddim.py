...
from ldm.modules.diffusionmodules.util import extract_into_tensor, make_ddim_sampling_parameters, make_ddim_timesteps, noise_like
...
class DDIMSampler(object):
    ...
    def p_sample_ddim(
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.0:
            ...
            x_in = torch.cat([x] * 2).half()
            t_in = torch.cat([t] * 2).half()
            c_in = torch.cat([unconditional_conditioning, c]).half()
